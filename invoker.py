...
METHODS_FUSION = {
                    'hpf': {'cpu': fusion_hpf_cpu, 'gpu': fusion_hpf_gpu},
                    'mean_value': {'cpu': fusion_valor_medio_cpu, 'gpu': fusion_valor_medio_gpu},
                    'high_pass': {'cpu': fusion_paso_alto_cpu, 'gpu':fusion_paso_alto_gpu},
                    'gram': {'cpu': fusion_gram_cpu, 'gpu': fusion_gram_gpu}
                  }
